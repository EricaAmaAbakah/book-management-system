...
export default function LibraryPage() {
  ...
  const genres: string[] = ["All", ...Array.from(new Set(books.map((book) => book.genre)))]
  const years: string[] = ["All", ...Array.from(new Set(books.map((book) => book.year.toString())))]
  ...
  const handleSaveEdit = () => {
    ...
    const updatedBooks = books.map((book) =>
      book.id === selectedBook.id ? { ...book, ...editFormData } as Book : book
    );
    setBooks(updatedBooks);
    setSelectedBook({ ...selectedBook, ...editFormData } as Book);
    setIsEditing(false);
    setImagePreview("");
  }
    ...
    <div className="library-page-container">
      <header className="library-header-nav">
        ...
        <nav className="library-nav">
          ...
          <a href="/library/login.php" className="nav-link">🔑 Login</a>
          <a href="/library/signup.php" className="nav-link">✨ Sign Up</a>
        </nav>
      </header>
